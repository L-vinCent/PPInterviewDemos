...
- (void)setSelected:(BOOL)selected{
    switch (_type) {
        ...
        {
            if (_titleLabel) {
                [_titleLabel setTextColor:(selected?[UIColor colorWithHexString:@"0x222222"]:[UIColor colorWithHexString:@"0x999999"])];
...
- (void)addRedLine
{
    if (!_lineView) {
        ...
        _lineView.backgroundColor = [UIColor colorWithHexString:@"0x222222"];
