...
#define Base_APIURL @"https://gateway.amez999.com/mobile/user" //接口正式服务器
...
#define Product_detail(productId) [NSString stringWithFormat:@"%@/goods/goodsSkuListVoList/%@",Base_APIURL,productId] //产品详情
